...
When you are posting a question to a forum, create a regular topic mark it as a question. The topic is marked with a question mark icon ![Question icon](faqs_16x16.gif) in the user interface so that forum users can easily identify it as a question.
...
**Parent topic:**[Posting questions and answers to a forum](../../user/forums/c_forums_post_q_and_as.md)
