...
For the supported versions of Kubernetes, Helm, and so on, see Supported versions \(TBD\).
...
:   See Supported versions \(TBD\). Component Pack for Connections follows the same Kubernetes support pattern that Kubernetes itself is following.
