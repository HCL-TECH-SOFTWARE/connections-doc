...
All deployments that upgrade from Connections 6.5 CR1 \(whether the upgrade is side by side, in-place, or hybrid\) are required to manually run a script to update the Homepage database schema.

**Note:** Do not use the database wizard to do this update.

After you've upgraded Connections to version 7.0, see one of the following topics according to your database environment.
