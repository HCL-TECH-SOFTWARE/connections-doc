...
|IBM HTTP Server|8.5.5.29 (1,2,3)|8.0 CR14|Supported Configuration|
...
|Tiny Editors for HCL Connections|4.9.2.59 (2)|8.0 CR14|Supported Configuration|
...
(2) Tiny Editor for HCL Connections 4.9.2.59 includes TinyMCE v7.9.1, upgraded from version v6.8.x
