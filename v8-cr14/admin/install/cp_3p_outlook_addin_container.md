# Integrating with Connections Outlook Add-in for Microsoft Outlook {#cp_3p_outlook_addin_container .concept}
...
The following steps provide information on registering the OAuth application provider for the HCL Connections Add-in for Microsoft Outlook when this add-in is deployed as part of Component Pack for Connections.
-   **[Registering the Connections Add-in in Microsoft Entra](../install/cp_3p_outlook_addin_microsoft_entra.md)**
These steps outline how to register the HCL Connections Outlook Add-in in the Microsoft Entra admin center (formerly Azure Active Directory) to enable secure communication with Microsoft services.
