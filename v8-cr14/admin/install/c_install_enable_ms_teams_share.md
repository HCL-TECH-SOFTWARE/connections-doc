...
The appregistry extension enables sharing Connections pages to Microsoft Teams through the Share icon. The JSON from `ms-teams-share-extension.json` can either be imported from a file or copied/pasted into the code editor of the appregistry client to create the extension.
...
When users click **MS Teams Share**, they can share the current Connections page link, or links for blogs, wikis, or forums, to any Team/Channel in Microsoft Teams.

To enable MS Teams to work within the Connections Share feature, perform the following:
...
2.  Set up the Appregistry extension
