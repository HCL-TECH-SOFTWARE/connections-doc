...
When you run the Profiles population wizard, you can record your selections in two response files: a `tdisettings.properties` file and a `mappings.properties` file.
