...
|Link-checking|`ephox.link-checking.enabled`|Enable or disable the link-checking service. See example C.|
|Link-checking|`ephox.link-checking.cache.capacity`|Maximum cached links. See example D.|
|Link-checking|`ephox.link-checking.cache.timeToLiveInSeconds`|Maximum time (seconds) a link may remain in cache. See example D.|
|Link-checking|`ephox.link-checking.cache.timeToIdleInSeconds`|Maximum idle time (seconds) since the last request. See example D.|
|Media-embed|`ephox.embed.enabled`|Enable or disable Enhanced Media Embed. See example E.|
...
|HTTP|`ephox.http.max-redirects`|Maximum number of redirects for link checks. See example J.|
...
|Security|`ephox.http.trust-all-cert`|Bypass SSL certificate validation (CAUTION). See example L.|
