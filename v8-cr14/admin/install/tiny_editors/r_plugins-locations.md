# Connections locations for selectively loading plugins {#plugins-locations .reference}

List of locations for selectively loading plugins.
...
|`unknown-comments`|Comment editors in an unknown location.|
