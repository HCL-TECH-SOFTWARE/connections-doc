...
3.  Add the `ephox.link-checking.enabled` and `ephox.embed.enabled` settings, along with any other [application.conf settings](r_application-conf.md) required for link checking and media embedding.
