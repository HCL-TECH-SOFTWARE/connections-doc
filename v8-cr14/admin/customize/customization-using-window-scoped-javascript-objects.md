...
As in the provided example, this JavaScript object is expected to contain all config extensions that should be available. It can also serve as a baseline but can be overridden through existing app registry extensions. For this, you can leverage the property `preferAppReg: true`.
