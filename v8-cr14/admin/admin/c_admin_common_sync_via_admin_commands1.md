...
This determines whether the user identified by the first parameter, which is an external ID, should be is active or inactive by checking the configured directory for the external ID. The main purpose of this command is to reactivate a user.
