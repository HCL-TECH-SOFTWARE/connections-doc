...
|version|The timestamp format, versionStamp, in the LotusConnections-config.xml file. This is updated on customizations and upgrades to ensure that static content URLs are updated.|
