...
- **Ignore Punctuation**
    ...
    Allows users to search for equivalent search terms by ignoring punctuation in the search term. By ignoring punctuation, users can find results that match the content regardless of punctuation.
