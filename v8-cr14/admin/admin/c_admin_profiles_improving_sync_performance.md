...
!!! note
    ...
    2.  Take a careful approach to the use of these techniques because they add some complexity to the process.
...
Phase 3 runs in parallel in each of the four TDI\_n directories. Partitions 0, 1, and 2 are processed in TDI\_1, partitions 3, 4, and 5 are processed in TDI\_2, and so on. In this way there is no overlap between the users whom the four processes synchronize.
