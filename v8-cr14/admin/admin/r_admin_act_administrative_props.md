...
-   **activities**
    ...
    `java.util.Vector` of hash tables representing the activities whose access will be modified. For example, joesactivities.

-   **members**

    `java.util.Vector` of hash tables representing the members returned from the `MemberService` object.

**AccessControlService.fetchAccess\(java.util.Hashtable activity\)**

Gets a list of all of the members that have access to the specified activity. Returns a `java.util.Vector` object; each object in the vector is a `java.util.Hashtable` object that describes one entry, either a user or group, in the access list. The elements returned in the Hashtable are:
...
-   **activities**
    ...
    `java.util.Vector` of hash tables representing the activities whose access will be modified.
...
!!! note 
    ...
    In 2.5, this command name changed from setMemberAccess to setMembersAccess.
...
-   **owner**
    ...
    `java.util.Hashtable` representing the member returned from the `MemberService` object.
...
-   **owners**
    ...
    `java.util.Vector` of hash tables representing the members to whom you want to give owner access.
...
!!! note 
    ...
    In 2.5, this command name changed from setReaderAccess to setReadersAccess.
...
-   **activities**
    ...
    `java.util.Vector` of hash tables; each hash table describes an activity to be deleted. For example, `janesactivities`.
...
-   **activities**
    ...
    `java.util.Vector` of hash tables; each hash table describes an activity to be exported. For example, `activities`.
...
-   **member**
    ...
    `java.util.Hashtable` representing the members returned from the MemberService object. For example, `paul_smith`.
...
-   **member**
    ...
    `java.util.Hashtable` representing the owners of archived activities returned from the MemberService object. For example, `paul_smith`.
...
-   **member**
    ...
    `java.util.Hashtable` representing the member who created the archived activities returned from the MemberService object. For example, `jane_doe`.
