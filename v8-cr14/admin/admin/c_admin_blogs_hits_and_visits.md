...
-   Referrer hits also count how many times a blog entry is accessed, but provide more information about where the hits come from. To view referrer hits, choose **Settings** for a blog, then click **Referrers**.
