...
1. Open a Windows shell \(cmd.exe\) and execute the following script:
...
2. Restart all Connections servers to publish the configuration to the Connections applications.
