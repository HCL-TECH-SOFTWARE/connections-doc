...
10. Enter the database information:
    ...
    6.  Ensure that the following JDBC driver libraries are present in the JDBC directory:
        ...
        SQL Server
        :   Download the [SQL Server JDBC 2](https://learn.microsoft.com/en-us/sql/connect/jdbc/release-notes-for-the-jdbc-driver?view=sql-server-ver16#42) driver from the Microsoft website to a local directory and enter that directory name in the **JDBC driver library** field.
