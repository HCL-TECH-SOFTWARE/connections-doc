...
To override the `connectionsAdmin` J2C authentication alias for a specific HCL Connections application, you need to define a J2C authentication alias for that application using the IBM® WebSphere® Application Server Integrated Solutions Console. For information about how to define a search J2C authentication alias for an application, see [Switching to unique administrator IDs for system level communication](../admin/t_admin_common_add_j2c_auth.md).
