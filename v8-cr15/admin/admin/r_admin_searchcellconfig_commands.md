...
-   `cell_name`. The name of the IBM WebSphere® Application Server cell hosting the HCL Connections Search application. This argument is a string value.
...
#### SearchCellConfig.setEcmPostFilteringConnectionTimeOut(long connectionTimeOutInMillis)
