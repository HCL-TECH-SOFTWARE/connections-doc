...
For an example of a Files application feature controlled by a `LotusConnections-config.xml` generic property in CR14, see [Disabling continuous scrolling in Files](files_t_disable_continuous_scrolling.md).
