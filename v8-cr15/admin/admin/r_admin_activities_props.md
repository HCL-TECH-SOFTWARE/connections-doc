...
!!! note
    ...
    Disabling this filter introduces vulnerability to cross-site scripting (XSS) and other types of malicious attacks. For more information, see *Securing applications from malicious attack*.
