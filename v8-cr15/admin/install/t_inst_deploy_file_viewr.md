...
|Adobe™ Reader|.pdf<br></br>**Note:** When viewing .pdf files, if you have accessibility requirements, download the file and then open it using a third party application that supports PDF accessibility.|
|Others|.txt, .rtf<br></br>**Note:** If you view a file in HCL Connections, .txt and .rtf can only be viewed in Connections 6.0 CR1 and later versions.|
