...
!!! Note
    ...
    An updated HCL Connections V8.0 Wizard that supports Microsoft SQL Server 2022 and 2025 is available on My HCLSoftware.
...
-   **[Using the database wizard in silent mode for SQL Server](../install/t_inst_wizard_silent_sql.md)**  
