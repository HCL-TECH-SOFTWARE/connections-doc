...
Depending on whether the IBM HTTP server was installed and configured during Connections installation, some of these tasks might already have been performed. Configure IBM HTTP Server to manage web requests to HCL Connections by following these steps.
...
Complete this task only if you did not select to configure IBM HTTP Server during the installation of HCL Connections.
