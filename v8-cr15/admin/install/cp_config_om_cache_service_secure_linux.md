...
!!! note
    ...
    -   This guide assumes an external load balancer is deployed outside the Kubernetes cluster to load balance Component Pack traffic. We use HAProxy in these instructions.
...
4. Repeat to copy the public key from HAProxy to each Kubernetes worker
