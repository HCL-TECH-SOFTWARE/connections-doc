...
-   If the DMGR profiles on which Connections is installed are not configured as the default profile, run the following commands before running the update installer command:
    -   Open a command line.
