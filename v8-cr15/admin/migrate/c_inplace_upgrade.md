...
With the Update function in IBM Installation Manager, you can upgrade the existing version of Connections to the next version, either in your production environment or in a new environment identical to production.
