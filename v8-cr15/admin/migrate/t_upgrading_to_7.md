...
-   On the system where the Deployment Manager is installed, prepare the supporting software for the update:
    ...
    -   Verify that you are running Installation Manager 1.9.1 64-bit.
