# Updating databases for 8.0 CR1 {#t_update_connections_databases_for_v80_cr1 .task}

If you update 8.0 to apply CR1, you must also update databases to accommodate new and changed features.

Connections™ 8.0 CR1 requires the following database updates, which you perform on the Deployment Manager:

1.  On the database server, download and extract the CR1 database update package [Connections 8.0 CR1](https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0077137) to a local directory.
...
2.  Update the Files and Wiki databases by completing the following steps:
    ...
    3.  Run the scripts to update the Files and Wiki databases.
        ...
        Refer to the [Update strategy for Connections 8.0](https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0077140) for more information.
