# Updating HCL Connections 8.0 with the latest Cumulative Refresh \(CR\) {#c_installing_fix-packs .concept}
...
- **[Updating Connections 8.0 with the latest Cumulative Refresh](../migrate/t_install_fixpack.md)**
