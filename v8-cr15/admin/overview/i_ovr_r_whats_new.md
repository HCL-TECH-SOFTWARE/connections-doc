...
New upload and share buttons on the top navigation make content sharing easier.
...
Expand the use of [Connections Engagement Center](../../connectors/icec/icec_welcome.md) throughout Connections by upgrading to a full version of the Engagement Center by purchasing an additional entitlement. Follow the instructions in [Installing Connections Engagement Center](../../connectors/icec/cec-install.md) after downloading the update and license package from [My HCLSoftware](https://my.hcltechsw.com/).
