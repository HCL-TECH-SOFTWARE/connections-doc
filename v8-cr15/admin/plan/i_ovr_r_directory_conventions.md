...
|`oracle_root`<br>Oracle database installation directory |Linux: `/home/oracle/oracle/product/version/db_1`<br>Windows: `drive:\oracle\product\version\db_1`<br><br>_where version is the supported Oracle number and drive is the system drive on which the file directory is stored. For example: C or D._|
