...
|-------|-----|--------|
|CLFWZ0001E: Failed to initialize widget lifecycle event propagator.|The widget lifecycle framework failed to initialize.|Validate widgets-config.xml settings. Report this problem to Customer Support. Additional information about the failure might be found in the SystemOut.log file.|
