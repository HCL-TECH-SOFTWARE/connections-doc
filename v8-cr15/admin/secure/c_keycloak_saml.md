...
For background on SAML \(Security Assertion Markup Language\), you can see these topics in the IBM documentation for WebSphere Application Server:
...
Single sign-on is accomplished by setting up a trust relationship between the Connections server and Keycloak using the WebSphere SAML Assertion Consumer Service Trust Association Interceptor (SAML ACS TAI).
