# Mode configuration {#reference_zkh_xgr_h1b .reference}
...
- **[Flyout button configureation](../../connectors/icec/cec-inst-flyout-button-config.md)**
To configure the flyout button to open the flyout page in a new tab, add a parameter to the header.jsp in the <CUSTOMIZATION\_DIR/\>.
