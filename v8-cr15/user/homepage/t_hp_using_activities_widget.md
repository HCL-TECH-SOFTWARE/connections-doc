...
-   To select a app view, click the Down arrow under the app title and select one of the following options:
    ...
    |View|Description|
    |----|-----------|
    |My Activities|In this view, the Activities app displays the most recent updates for your personal activities.Click the links next to the calendar to view the latest updates to your posts or high priority activities, or to open the Activities app. <br> For information about how to use the calendar, see *Using the calendar in the Activities app*.|
