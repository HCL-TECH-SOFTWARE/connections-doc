...
-   To change views, click the Down arrow under the app title and select one of the following options:
    ...
    !!! note
        ...
        The **Recently Visited** filter in the Communities app now shows only communities that you have actually opened. In CR14, communities that were only recently updated no longer appear in this view, and the list is sorted by most recent visit time.
