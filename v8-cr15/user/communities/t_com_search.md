...
-   **Filtering views in the Communities app:** From the navigation bar, click **Communities** and then select any of the following views:
    ...
    - **Recently Visited:** Shows the communities that you have recently opened. This view is sorted by the most recent visit time, with the most recently visited communities appearing at the top of the list. In CR14, communities that were only recently updated no longer appear in this view, and the list is sorted by most recent visit time.
