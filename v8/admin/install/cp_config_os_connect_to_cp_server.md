...
7.  Now configure OpenSearch metrics within Connections by completing the following steps:
    ...
    5.  If you are using type-ahead search on a separate cluster, add the SSL configuration as explained in [Steps to install or upgrade to Component Pack 8](../install/cp_install_services_tasks.md).
