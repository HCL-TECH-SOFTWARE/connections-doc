...
2. Get the index list, which will be migrated into the new OpenSearch instance using the following commands:
   ...
   4. Record the index names for the applications that you intend to migrate. These names will be used in the rest of the migration process.
