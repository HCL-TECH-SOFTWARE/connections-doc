...
8.  Add the following properties and values.
    ...
    |provider_1.useRealm|defaultWIMFileBasedRealm <br> </br> This is the default realm used by WebSphere. However, this value must match the realm name defined in the WAS console under **Global Security** > **Realm name**.|
