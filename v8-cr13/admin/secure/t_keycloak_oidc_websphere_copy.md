...
10.  Add the following properties and values.
    ...
    |provider_1.endSessionEndpointUrl | https://{keycloak_server}/homepage/|
    |provider_2.endSessionEndpointUrl | https://{keycloak_server}/homepage/|
    |provider_3.endSessionEndpointUrl | https://{keycloak_server}/homepage/|
    |provider_4.endSessionEndpointUrl | https://{keycloak_server}/homepage/|
